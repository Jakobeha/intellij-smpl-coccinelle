...
public class SmPLCContinueStructDeclListImpl extends SmPLCCompositeElementImpl implements SmPLCContinueStructDeclList {

  public SmPLCContinueStructDeclListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLCVisitor visitor) {
    visitor.visitContinueStructDeclList(this);
  }
  ...
  public SmPLCStructDecl getStructDecl() {
    return findNotNullChildByClass(SmPLCStructDecl.class);
  }
