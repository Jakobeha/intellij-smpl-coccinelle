...
public class SmPLCDeclMetaImpl extends SmPLCCompositeElementImpl implements SmPLCDeclMeta {

  public SmPLCDeclMetaImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLCVisitor visitor) {
    visitor.visitDeclMeta(this);
  }
