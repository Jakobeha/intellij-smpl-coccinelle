...
public class SmPLCDeclStmtImpl extends SmPLCStmtImpl implements SmPLCDeclStmt {

  public SmPLCDeclStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SmPLCDeclVar getDeclVar() {
    return findChildByClass(SmPLCDeclVar.class);
  }
