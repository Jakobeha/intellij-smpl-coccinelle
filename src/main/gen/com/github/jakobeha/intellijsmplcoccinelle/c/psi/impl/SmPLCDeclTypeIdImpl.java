...
public class SmPLCDeclTypeIdImpl extends SmPLCCompositeElementImpl implements SmPLCDeclTypeId {

  public SmPLCDeclTypeIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLCVisitor visitor) {
    visitor.visitDeclTypeId(this);
  }
