...
public class SmPLCDefineFuncImpl extends SmPLCCompositeElementImpl implements SmPLCDefineFunc {

  public SmPLCDefineFuncImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLCVisitor visitor) {
    visitor.visitDefineFunc(this);
  }
