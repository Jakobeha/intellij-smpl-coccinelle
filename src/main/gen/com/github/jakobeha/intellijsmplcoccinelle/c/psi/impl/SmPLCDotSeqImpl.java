...
public class SmPLCDotSeqImpl extends SmPLCCompositeElementImpl implements SmPLCDotSeq {

  public SmPLCDotSeqImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLCVisitor visitor) {
    visitor.visitDotSeq(this);
  }
