...
public class SmPLCExprImpl extends SmPLCCompositeElementImpl implements SmPLCExpr {

  public SmPLCExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SmPLCExprRec getExprRec() {
    return findNotNullChildByClass(SmPLCExprRec.class);
  }
