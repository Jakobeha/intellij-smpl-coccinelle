...
public class SmPLCParamImpl extends SmPLCCompositeElementImpl implements SmPLCParam {

  public SmPLCParamImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public PsiElement getDoubleEllipsis() {
    return findChildByType(DOUBLE_ELLIPSIS);
  }
