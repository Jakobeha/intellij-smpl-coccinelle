...
public class SmPLCParamSeqImpl extends SmPLCCompositeElementImpl implements SmPLCParamSeq {

  public SmPLCParamSeqImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLCVisitor visitor) {
    visitor.visitParamSeq(this);
  }
