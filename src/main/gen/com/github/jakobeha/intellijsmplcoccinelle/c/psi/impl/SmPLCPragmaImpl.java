...
public class SmPLCPragmaImpl extends SmPLCCompositeElementImpl implements SmPLCPragma {

  public SmPLCPragmaImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SmPLCId> getIdList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SmPLCId.class);
  }
