...
public class SmPLCSingleDeclFnInitImpl extends SmPLCCompositeElementImpl implements SmPLCSingleDeclFnInit {

  public SmPLCSingleDeclFnInitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLCVisitor visitor) {
    visitor.visitSingleDeclFnInit(this);
  }
