...
public class SmPLCSingleDeclIdentsImpl extends SmPLCCompositeElementImpl implements SmPLCSingleDeclIdents {

  public SmPLCSingleDeclIdentsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLCVisitor visitor) {
    visitor.visitSingleDeclIdents(this);
  }
