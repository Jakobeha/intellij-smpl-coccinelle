...
public class SmPLCSingleRuleElemStmtBreakImpl extends SmPLCCompositeElementImpl implements SmPLCSingleRuleElemStmtBreak {

  public SmPLCSingleRuleElemStmtBreakImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLCVisitor visitor) {
    visitor.visitSingleRuleElemStmtBreak(this);
  }
