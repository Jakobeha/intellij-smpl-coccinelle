...
public class SmPLCSingleRuleElemStmtReturnImpl extends SmPLCCompositeElementImpl implements SmPLCSingleRuleElemStmtReturn {

  public SmPLCSingleRuleElemStmtReturnImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLCVisitor visitor) {
    visitor.visitSingleRuleElemStmtReturn(this);
  }
