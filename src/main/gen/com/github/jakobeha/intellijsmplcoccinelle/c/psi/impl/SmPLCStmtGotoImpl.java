...
public class SmPLCStmtGotoImpl extends SmPLCCompositeElementImpl implements SmPLCStmtGoto {

  public SmPLCStmtGotoImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLCVisitor visitor) {
    visitor.visitStmtGoto(this);
  }
