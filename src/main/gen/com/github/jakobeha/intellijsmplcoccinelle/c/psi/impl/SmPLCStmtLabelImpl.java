...
public class SmPLCStmtLabelImpl extends SmPLCCompositeElementImpl implements SmPLCStmtLabel {

  public SmPLCStmtLabelImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLCVisitor visitor) {
    visitor.visitStmtLabel(this);
  }
