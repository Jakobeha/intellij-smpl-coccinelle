...
public class SmPLCTypedefIdentImpl extends SmPLCCompositeElementImpl implements SmPLCTypedefIdent {

  public SmPLCTypedefIdentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLCVisitor visitor) {
    visitor.visitTypedefIdent(this);
  }
