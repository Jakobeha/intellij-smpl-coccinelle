...
public class SmPLCUndefImpl extends SmPLCCompositeElementImpl implements SmPLCUndef {

  public SmPLCUndefImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getHashUndef() {
    return findNotNullChildByType(HASH_UNDEF);
  }
