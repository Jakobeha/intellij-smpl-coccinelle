...
public class SmPLAttributeMetadeclImpl extends SmPLMetadeclImpl implements SmPLAttributeMetadecl {

  public SmPLAttributeMetadeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitAttributeMetadecl(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getAttribute() {
    return findNotNullChildByType(ATTRIBUTE);
  }
