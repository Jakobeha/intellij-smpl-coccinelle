...
public class SmPLAttributeNameMetadeclImpl extends SmPLMetadeclImpl implements SmPLAttributeNameMetadecl {

  public SmPLAttributeNameMetadeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitAttributeNameMetadecl(this);
  }
