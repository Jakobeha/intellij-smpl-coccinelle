...
public class SmPLBinopdeclImpl extends SmPLCompositeElementImpl implements SmPLBinopdecl {

  public SmPLBinopdeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitBinopdecl(this);
  }
  ...
  @Override
  @NotNull
  public List<SmPLBinop> getBinopList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SmPLBinop.class);
  }
