...
public class SmPLConstantMetadeclImpl extends SmPLMetadeclImpl implements SmPLConstantMetadecl {

  public SmPLConstantMetadeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitConstantMetadecl(this);
  }
  ...
  public PsiElement getConstant() {
    return findNotNullChildByType(CONSTANT);
  }
