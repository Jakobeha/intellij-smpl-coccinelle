...
public class SmPLDeclarationMetadeclImpl extends SmPLMetadeclImpl implements SmPLDeclarationMetadecl {

  public SmPLDeclarationMetadeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitDeclarationMetadecl(this);
  }
  ...
  public PsiElement getDeclaration() {
    return findNotNullChildByType(DECLARATION);
  }
