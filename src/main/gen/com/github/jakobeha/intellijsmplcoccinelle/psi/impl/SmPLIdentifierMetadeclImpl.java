...
public class SmPLIdentifierMetadeclImpl extends SmPLMetadeclImpl implements SmPLIdentifierMetadecl {

  public SmPLIdentifierMetadeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitIdentifierMetadecl(this);
  }
  ...
  @Override
  @Nullable
  public PsiElement getIdentifierList() {
    return findChildByType(IDENTIFIER_LIST);
  }
