...
public class SmPLInitializerMetadeclImpl extends SmPLMetadeclImpl implements SmPLInitializerMetadecl {

  public SmPLInitializerMetadeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitInitializerMetadecl(this);
  }
  ...
  public PsiElement getInitializer() {
    return findChildByType(INITIALIZER);
  }

  @Override
  @Nullable
  public PsiElement getInitializerList() {
    return findChildByType(INITIALIZER_LIST);
  }
