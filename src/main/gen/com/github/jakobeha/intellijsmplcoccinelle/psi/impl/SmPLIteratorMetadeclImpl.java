...
public class SmPLIteratorMetadeclImpl extends SmPLMetadeclImpl implements SmPLIteratorMetadecl {

  public SmPLIteratorMetadeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitIteratorMetadecl(this);
  }
