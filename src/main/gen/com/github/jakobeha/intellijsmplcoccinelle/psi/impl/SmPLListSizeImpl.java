...
public class SmPLListSizeImpl extends SmPLCompositeElementImpl implements SmPLListSize {

  public SmPLListSizeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitListSize(this);
  }
  ...
  @Override
  @Nullable
  public SmPLInteger getInteger() {
    return findChildByClass(SmPLInteger.class);
  }
