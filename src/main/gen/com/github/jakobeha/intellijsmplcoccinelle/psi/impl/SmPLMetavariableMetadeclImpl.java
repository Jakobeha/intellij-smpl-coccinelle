...
public class SmPLMetavariableMetadeclImpl extends SmPLMetadeclImpl implements SmPLMetavariableMetadecl {

  public SmPLMetavariableMetadeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitMetavariableMetadecl(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getMetavariable() {
    return findNotNullChildByType(METAVARIABLE);
  }
