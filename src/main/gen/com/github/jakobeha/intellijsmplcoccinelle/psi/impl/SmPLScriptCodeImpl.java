...
public class SmPLScriptCodeImpl extends SmPLCompositeElementImpl implements SmPLScriptCode {

  public SmPLScriptCodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitScriptCode(this);
  }
  ...
  @Override
  @NotNull
  public SmPLScriptMetavariables getScriptMetavariables() {
    return findNotNullChildByClass(SmPLScriptMetavariables.class);
  }
