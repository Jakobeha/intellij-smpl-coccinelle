...
public class SmPLScriptMetadeclAssignImpl extends SmPLCompositeElementImpl implements SmPLScriptMetadeclAssign {

  public SmPLScriptMetadeclAssignImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitScriptMetadeclAssign(this);
  }
