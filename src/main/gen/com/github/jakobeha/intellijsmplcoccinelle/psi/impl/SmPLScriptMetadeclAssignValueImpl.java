...
public class SmPLScriptMetadeclAssignValueImpl extends SmPLCompositeElementImpl implements SmPLScriptMetadeclAssignValue {

  public SmPLScriptMetadeclAssignValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitScriptMetadeclAssignValue(this);
  }
