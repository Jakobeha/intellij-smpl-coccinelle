...
public class SmPLStatementMetadeclImpl extends SmPLMetadeclImpl implements SmPLStatementMetadecl {

  public SmPLStatementMetadeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitStatementMetadecl(this);
  }
  ...
  public PsiElement getStatement() {
    return findChildByType(STATEMENT);
  }

  @Override
  @Nullable
  public PsiElement getStatementList() {
    return findChildByType(STATEMENT_LIST);
  }
