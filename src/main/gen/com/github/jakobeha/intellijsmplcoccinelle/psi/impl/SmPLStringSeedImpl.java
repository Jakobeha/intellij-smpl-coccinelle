...
public class SmPLStringSeedImpl extends SmPLCompositeElementImpl implements SmPLStringSeed {

  public SmPLStringSeedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitStringSeed(this);
  }
