...
public class SmPLSymbolMetadeclImpl extends SmPLMetadeclImpl implements SmPLSymbolMetadecl {

  public SmPLSymbolMetadeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitSymbolMetadecl(this);
  }
