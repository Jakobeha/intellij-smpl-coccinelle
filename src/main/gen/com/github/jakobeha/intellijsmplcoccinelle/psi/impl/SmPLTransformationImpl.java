...
public class SmPLTransformationImpl extends SmPLCompositeElementImpl implements SmPLTransformation {

  public SmPLTransformationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SmPLMetavariables getMetavariables() {
    return findNotNullChildByClass(SmPLMetavariables.class);
  }
