...
public class SmPLTypedefMetadeclImpl extends SmPLMetadeclImpl implements SmPLTypedefMetadecl {

  public SmPLTypedefMetadeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitTypedefMetadecl(this);
  }
  ...
  @Override
  @Nullable
  public SmPLPmids getPmids() {
    return findChildByClass(SmPLPmids.class);
  }
