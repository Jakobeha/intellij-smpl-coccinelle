...
public class SmPLUnopdeclImpl extends SmPLCompositeElementImpl implements SmPLUnopdecl {

  public SmPLUnopdeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitUnopdecl(this);
  }
  ...
  @Override
  @NotNull
  public List<SmPLUnop> getUnopList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SmPLUnop.class);
  }
