...
public class SmPLUsingRuleattrImpl extends SmPLCompositeElementImpl implements SmPLUsingRuleattr {

  public SmPLUsingRuleattrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitUsingRuleattr(this);
  }
