...
public class SmPLUsingSysCocciImpl extends SmPLCompositeElementImpl implements SmPLUsingSysCocci {

  public SmPLUsingSysCocciImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SmPLVisitor visitor) {
    visitor.visitUsingSysCocci(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getSyspath() {
    return findNotNullChildByType(SYSPATH);
  }
